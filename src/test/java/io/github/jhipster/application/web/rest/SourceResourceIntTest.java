...
import io.github.jhipster.application.repository.SourceRepository;
...
public class SourceResourceIntTest {
    ...
    public void createSource() throws Exception {
        ...
        assertThat(testSource.getHandle()).isEqualTo(DEFAULT_HANDLE);
    }
    ...
    public void updateSource() throws Exception {
        ...
        assertThat(testSource.getHandle()).isEqualTo(UPDATED_HANDLE);
    }
